...
async def get_top_headlines(session, url, q=None, country='ar', category=None, api_key=None):
    if api_key is None:
...
if __name__ == '__main__':
    ...
    #print(type(results))
    #print(results[0])
    print('{} top headlines for Argentina'.format(int(results[0]['totalResults'])))
